...
let defaultMajor = "computer science";
let courseCatalog = {};
...
function updateProgress() {
  let totalCredits = 0;
  const cat = { cscore: 0, dscore: 0, cse: 0, dse: 0, math: 0, gened: 0, elective: 0, writing: 0 };
  ...
  updateCategoryProgress('dscore', cat.dscore, 34, 'dsCoreComplete');
  updateCategoryProgress('cse', cat.cse, 45, 'csElectiveComplete');
  updateCategoryProgress('dse', cat.dse, 27, 'dsElectiveComplete');
  updateCategoryProgress('math', cat.math, 10, 'mathComplete');
  updateCategoryProgress('gened', cat.gened, 30, 'genEdComplete');
  updateCategoryProgress('elective', cat.elective, 17, 'electiveComplete');
  updateCategoryProgress('writing', cat.writing, 3, 'writingComplete');
}
